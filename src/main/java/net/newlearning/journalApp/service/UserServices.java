...
public class UserServices {
    ...
    //@Slf4j is used to not write this line again and again
    //or in @Slf4j the  by Default  variable is used is "log"
//    private static  final Logger logger = LoggerFactory.getLogger(UserServices.class);
    public boolean saveNewUser(User user) {
        try {
            ...
            // this is used to show the error on  a particular instance
